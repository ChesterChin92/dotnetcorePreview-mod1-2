...
```sh
    dotnet 
```
![](module1-gif/test-if-dotnet-installed-in-terminal.gif
)
...
```sh
    ...
    dotnet new console
```
![](module1-gif/create-directory-and-init-console-app.gif
)
...
```sh
    dotnet restore
```
![](module1-gif/dotnet-restore.gif)
...
```
![](module1-gif/create-startup-cs.gif)
...
```
![](module1-gif/update-program-cs-to-web-code.gif)
- Run the app 
```sh
    dotnet run
```
